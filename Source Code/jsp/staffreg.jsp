...
<title>Insert title here</title>
 <link rel="stylesheet" href="css1/bootstrap.min.css">
  ...
  <style>
  body {
  background-image:url("images/istockphoto-93986062-612x612.jpg");
...
<body>
  ...
  <div class="container" >
    ...
    <form method="post" action="SlregServlet" enctype="multipart/form-data">
     <div class="row">
       <div class="card col-sm-6" style="padding-bottom:10px;border-radius:50px;background: linear-gradient(90deg, rgba(58,180,175,1) 0%, rgba(108,76,76,1) 45%, rgba(252,176,69,1) 100%);color:#fff;padding:10px;margin-left:25%;width: 38em;margin-bottom: 25px">
